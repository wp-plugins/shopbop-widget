...
if(!class_exists('CoreWidget'))
{
    ...
    class CoreWidget
    {
    	...
    	{
    		//CSS links
    		wp_enqueue_style(constant(self::$widgetPrefix.'PUBLIC_WIDGET_NAME_SLUG') . '-customjs', constant(self::$widgetPrefix.'PLUGIN_DIR_URL') . 'css/public_widget.css?where=blog');
    		...
    		wp_enqueue_script(constant(self::$widgetPrefix.'PUBLIC_WIDGET_NAME_SLUG') . '-customjs', constant(self::$widgetPrefix.'PLUGIN_DIR_URL') . 'js/public_widget.js?where=blog');
    	}
