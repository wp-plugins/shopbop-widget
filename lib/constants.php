...
//Widget pane to open
if(!defined($widgetPrefix . 'WIDGET_DEFAULT_AFFILIATE_INFO'))
    define($widgetPrefix . 'WIDGET_DEFAULT_AFFILIATE_INFO', 'nothanks');

//Widget pane to open
if(!defined($widgetPrefix . 'WIDGET_DEFAULT_AFFILIATE_CJ_ID'))
    define($widgetPrefix . 'WIDGET_DEFAULT_AFFILIATE_CJ_ID', '11585200');
